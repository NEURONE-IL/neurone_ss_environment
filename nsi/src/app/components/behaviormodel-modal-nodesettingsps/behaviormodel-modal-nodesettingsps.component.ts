...
@Component({
  selector: 'app-behaviormodel-modal-nodesettingsps',
  templateUrl: './behaviormodel-modal-nodesettingsps.component.html',
  styleUrls: ['./behaviormodel-modal-nodesettingsps.component.css']
})

// NodeSettingsBUE: Node settings modal for Page and SERP nodes
export class BehaviorModelModalNodeSettingsPSComponent {
